...
#
# Restored from AIAK (compat): LoongForge's tokenizer layer subclasses
# MegatronLegacyTokenizer from this path. The community v0.19 tree moved the
# tokenizer abstractions to megatron/core/tokenizers/ (different interface —
# path/config constructor); this legacy ABC is kept for downstream callers.
import json
