...
class BaseMoELayer(MegatronModule, ABC):
    ...
    def __init__(
        ...
        # Preserve the legacy attribute name for backward compatibility with existing code
        # (e.g. upcycling_utils.py) that reads mlp.num_local_experts. It equals the number of
        # home (non-echo) experts on this rank, matching the pre-echo semantics.
...
class MoELayer(BaseMoELayer):
    ...
    def forward(self, hidden_states: torch.Tensor, input_ids: Optional[torch.Tensor] = None):
        ...
        def custom_forward(hidden_states):
            ...
            hidden_states, probs, metadata, residual = self.router_and_preprocess(
