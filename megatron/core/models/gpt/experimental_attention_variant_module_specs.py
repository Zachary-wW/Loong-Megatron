...
def get_transformer_layer_with_experimental_attention_variant_spec(
    ...
    **Note that, this API is a experimental API in the short term, and might be deprecated in the
    ...
    # Adaptation (M-30 on the v0.19.2 base): mHC lives in the base
    # TransformerLayer (M-24 wiring, AIAK approach) rather than dev's
    # HyperConnectionTransformerLayer subclass — the hc submodules slots
    # below drive it either way.
