...
"""
Entry points for Linear + Cross-Entropy fusion on Blackwell architecture.

This module provides forward and backward functions for the fused
linear layer and cross-entropy loss computation optimized for Blackwell GPUs.
"""
