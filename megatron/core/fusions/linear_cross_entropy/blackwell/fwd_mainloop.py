...
try:
    ...
    class FwdMainLoop:
        ...
        def _compute_stages(
            ...
            """
            Compute the number of pipeline stages for the forward kernel.
            ...
            Returns:
                Tuple of (num_acc_stage, num_a_stage, num_b_stage, num_epi_stage_per_tile).
            """
        ...
        def _compute_grid(
            ...
            Args:
                ...
                num_splits: Number of vocabulary splits.
        ...
        def __call__(
            ...
            """
            Launch the forward kernel for the mainloop computation.

            Args:
                hidden: Input hidden states tensor.
                weight: Embedding weight tensor.
                labels: Labels tensor.
                _logprobs: Log probabilities tensor.
                _max: Maximum values tensor.
                _accu: Accumulated values tensor.
