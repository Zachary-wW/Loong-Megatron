...
"""
Utilities for Linear + Cross-Entropy fusion.

This module provides common utilities including enums and helper functions
used by the fused linear and cross-entropy implementations.
"""
