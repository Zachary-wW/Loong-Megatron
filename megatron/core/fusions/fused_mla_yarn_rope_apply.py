...
# ============================================================================
# AIAK-era per-head Q/KV YARN-RoPE autograd entries (compat, migrated from the
# AIAK fork). The community dev version dropped these in favor of the fused
# inplace/concat paths, but downstream vendored code (LoongForge DSA/MLA) and
# megatron's own MLA (fused_apply_mla_rope_for_q/kv, currently try/except-
# guarded) consume them. Restoring also re-enables the fused path for MLA.
# ============================================================================
